...
public class Kintai {
    ...
    // ===== 新しく追加する休憩時間フィールド =====
    private Integer breakTimeH; // 休憩時間（時）
    private Integer breakTimeM; // 休憩時間（分）
    ...
    public Integer getBreakTimeH() {
        return breakTimeH;
    }

    public void setBreakTimeH(Integer breakTimeH) {
        this.breakTimeH = breakTimeH;
    }

    public Integer getBreakTimeM() {
        return breakTimeM;
    }

    public void setBreakTimeM(Integer breakTimeM) {
